...
[
  {
    ...
    "officer_name_kn": "ಅಧಿಕಾರಿಯ ಸಂಪೂರ್ಣ ಹೆಸರು ಮತ್ತು ಗ್ರೇಡ್ ಕನ್ನಡದಲ್ಲಿ (e.g. ಶ್ರೀ ಕೆ.ಎ. ಹಿದಾಯತ್ತುಲ್ಲಾ, ಕೆ.ಎ.ಎಸ್ (ಸೂಪರ್ ಟೈಮ್ ಸ್ಕೇಲ್))",
    "officer_name_en": "Officer Name in English",
    "previous_posting": "ಹಿಂದಿನ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತಿದ್ದ ಹುದ್ದೆ ಮತ್ತು ಇಲಾಖೆ",
    "new_posting": "ವರ್ಗಾಯಿಸಿ ನೇಮಿಸಲಾದ ನೂತನ ಹುದ್ದೆ / ಹೆಚ್ಚುವರಿ ಹೊಣೆ",
    "district_key": "district_key (e.g. bengaluru_urban, tumakuru, yadgir, mysuru, belagavi, kalaburagi, dharwad, vijayapura)",
    "summary_kn": "ಅಧಿಕೃತ ಸರ್ಕಾರಿ ಆದೇಶದ ಸಂಪೂರ್ಣ ಶುದ್ಧ ಕನ್ನಡ ವಿವರಣೆ"
  }
]
