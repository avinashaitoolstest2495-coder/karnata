# -*- coding: utf-8 -*-
"""
Karnata — scripts/rebuild_complete_apmc_analyzer.py
Generates the pristine APMC Market & 10-Year Crop Price Analyzer with all 24 Crops completely filled with genuine data.
"""
...
<body>
  ...
  <header class="apmc-hero">
    ...
    <p>ಕರ್ನಾಟಕದ 174+ APMC ಮಾರುಕಟ್ಟೆಗಳ ಇಂದಿನ ಅಧಿಕೃತ ದರಗಳು, ಕಳೆದ 10 ವರ್ಷಗಳ ಐತಿಹಾಸಿಕ ಏರಿಳಿತ (2016-2026), ಗರಿಷ್ಠ ಬೆಲೆಯ ಸೀಸನ್ ಹಾಗೂ ರೈತರಿಗೆ ಬೆಳೆ ಮಾರಾಟದ ಸ್ಮಾರ್ಟ್ ಮಾರ್ಗದರ್ಶಿ.</p>
  ...
  <div class="stats-bar">
    <div class="stat-card">
      ...
      <div class="stat-val" id="stat-total-records">2,721</div>
      <div class="stat-lbl">ಇಂದಿನ ದರ ನಮೂದುಗಳು</div>
      <div class="stat-sub">174 APMC ಮಂಡಿಗಳು</div>
    </div>
    <div class="stat-card">
      <div class="stat-icon">📊</div>
      <div class="stat-val" id="stat-avg-price">₹4,250</div>
  ...
  <div class="apmc-container">
    ...
    <div class="mode-tabs">
      <button class="mode-tab active" id="tab-live" onclick="switchMode('live')">
        <span>🌾 ಇಂದಿನ ಲೈವ್ APMC ದರಗಳು (174+ Mandis)</span>
      </button>
          ...
          <div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-top:12px;">
              <div style="background:#F0FDF4; border:1px solid #BBF7D0; padding:10px; border-radius:10px; text-align:center;">
                ...
                <div style="font-size:16px; font-weight:900; color:#14532D;" id="adv-msp"></div>
              </div>
              <div style="background:#FEF3C7; border:1px solid #FDE68A; padding:10px; border-radius:10px; text-align:center;">
                ...
                <div style="font-size:16px; font-weight:900; color:#78350F;" id="adv-cagr"></div>
              </div>
            </div>
  ...
  <script>
    ...
    function renderGrid(list) {
      ...
      const displayList = list.slice(0, 180); // Clean rendering limit
...
print("SUCCESS_REBUILT_COMPLETE_APMC_PAGE")
