...
window.AskKARNATAEngine = (function() {
  ...
  function query(userQuery) {
    ...
    // 7. CHIEF MINISTER, CABINET & GOVERNANCE (CM, Siddaramaiah, Ministers, 5 Guarantees)
...
* **ಮುಖ್ಯಮಂತ್ರಿ (Chief Minister):** **ಡಿ.ಕೆ. ಶಿವಕುಮಾರ್ (D.K. Shivakumar)**
  ...
  * *ಖಾತೆಗಳು:* ಹಣಕಾಸು, ಸಿಬ್ಬಂದಿ ಮತ್ತು ಆಡಳಿತ ಸುಧಾರಣೆ (DPAR), ಗುಪ್ತಚರ, ಮಾಹಿತಿ, ಕಾನೂನು & ನ್ಯಾಯ, ಸಂಸದೀಯ ವ್ಯವಹಾರಗಳು, ಕೃಷಿ ಮಾರುಕಟ್ಟೆ, ಬಿಡಿಎ/ಬಿಎಂಆರ್‌ಡಿಎ ಹಾಗೂ ಹಂಚಿಕೆಯಾಗದ ಎಲ್ಲಾ ಖಾತೆಗಳು.
...
* **ಡಾ. ಜಿ. ಪರಮೇಶ್ವರ್:** ಉಪಮುಖ್ಯಮಂತ್ರಿಗಳು & ಕಂದಾಯ, ಯುವಜನ ಸೇವೆ, ಕ್ರೀಡೆ
* **ಹೆಚ್.ಕೆ. ಪಾಟೀಲ್:** ಕಾನೂನು, ನ್ಯಾಯ ಮತ್ತು ಪ್ರವಾಸೋದ್ಯಮ ಸಚಿವರು
* **ಎಂ.ಬಿ. ಪಾಟೀಲ್:** ಬೃಹತ್ ಮತ್ತು ಮಧ್ಯಮ ಕೈಗಾರಿಕೆಗಳು & ಮೂಲಸೌಕರ್ಯ
* **ಕೃಷ್ಣ ಬೈರೇಗೌಡ:** ಕಂದಾಯ ಸಚಿವರು (Revenue)
* **ರಾಮಲಿಂಗಾರೆಡ್ಡಿ:** ಸಾರಿಗೆ ಮತ್ತು ಮುಜರಾಯಿ ಸಚಿವರು
* **ಪ್ರಿಯಾಂಕ್ ಖರ್ಗೆ:** ಗ್ರಾಮೀಣಾಭಿವೃದ್ಧಿ & ಪಂಚಾಯತ್ ರಾಜ್, ಐಟಿ-ಬಿಟಿ
